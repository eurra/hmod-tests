...
import hmod.domain.binary.components.Randomize;
 ...
 */
public class RandomizeScript extends SingleGraphScript
{
    public RandomizeScript(GraphHandler input)
    {
        super(input);
    }
    ...
    public void process() throws BuildException
    {
        ...
        branch("binExample_randomize").value(
        ...
        step2.value(
            sequentialStep().
            addOperator(
                operator(Randomize.class).setData(ref("binExample_data"))
            )
        );
    }
}
